...
const students = [
    ...
    { name: 'Dewi Thoatika Nurjanah', nickname: 'Dewi', ig: '@jnhnrthdw' },
    ...
    { name: 'Khoirul Anisa Putri', nickname: 'Kep', ig: '@khanisaptry' },
    { name: 'Lequinsha Zalyandra Bilqis', nickname: 'Lequin', ig: '@le.quinsha' },
    { name: 'Lintang Azzalea Pratama', nickname: 'Lintang', ig: '@lingtangazzaleaa_' },
    { name: 'Lutfiah Thalita Azmi', nickname: 'Tata', ig: '@lutfiatalitaazmi_' },
    { name: 'Miftah Khoiron Ramadhan', nickname: 'Miftah', ig: '@' },
    { name: 'Moura Dealova Kanza Adiba T', nickname: 'Moura', ig: '@mouraknza' },
    { name: 'Muhammad Rizky Maulana', nickname: 'Jajat', ig: '@rzkimaulna_908' },
    { name: 'Muhammad Adelio Faustin AB', nickname: 'Adel', ig: '@lio_awikwok' },
    { name: 'Nabilla Oktavia Andini', nickname: 'Okta', ig: '@' },
    { name: 'Nova Zaidah', nickname: 'Nova', ig: '@nova.zaidah' },
    { name: 'Poros Baroki Bumas', nickname: 'Rocky/Poros', ig: '@rockyy_barrr' },
    ...
    { name: 'Zafir Raihan Basri', nickname: 'Zafir', ig: '@zafir.ye' },
    { name: 'Zalfa Zahirah', nickname: 'Zalfa', ig: '@z.zaalxx' },
];
