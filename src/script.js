...
const students = [
    ...
    { name: 'Kayla Khalidah Tajudin', nickname: 'Kay', ig: '@omarbakri' },
    { name: 'Keyla Nur Hasanah', nickname: 'Key', ig: '@putriayu' },
    { name: 'Khoirul Anisa Putri', nickname: 'Kep', ig: '@qorihidayat' },
    { name: 'Lequinsha Zalyandra Bilqis', nickname: 'Lequin', ig: '@rianhidayat' },
    { name: 'Lintang Azzalea Pratama', nickname: 'Lintang', ig: '@siskawulan' },
    { name: 'Lutfiah Thalita Azmi', nickname: 'Tata', ig: '@tonosupriyadi' },
    { name: 'Miftah Khoiron Ramadhan', nickname: 'Miftah', ig: '@umikalsum' },
    { name: 'Moura Dealova Kanza Adiba T', nickname: 'Moura', ig: '@vinapandu' },
    { name: 'Muhammad Rizky Maulana', nickname: 'Jajat', ig: '@wahyunugroho' },
    { name: 'Muhammad Adelio Faustin AB', nickname: 'Adel', ig: '@xena_angg' },
    { name: 'Nabilla Oktavia Andini', nickname: 'Okta', ig: '@yogapras' },
    { name: 'Nova Zaidah', nickname: 'Nova', ig: '@zahraaulia' },
    { name: 'Poros Baroki Bumas', nickname: 'Poros', ig: '@adinugroho' },
    { name: 'Rayiandra Abinaya', nickname: 'Abi', ig: '@bellasafitri' },
    { name: 'Rizqi Khoiril Ibad', nickname: 'Aril', ig: '@candrakirana' },
    { name: 'Steven Febrian Pratama', nickname: 'Steven', ig: '@dimasardi' },
    { name: 'Zafir Raihan Basri', nickname: 'Zafir', ig: '@erlinkusuma' },
    { name: 'Zalfa Zahirah', nickname: 'Zalfa', ig: '@fikrihaikal' },
];
